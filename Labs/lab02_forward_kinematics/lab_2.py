...
class ForwardKinematics(Node):
   ...
   def forward_kinematics_b(self, theta1, theta2, theta3):
       theta1 = theta1 + 0.08922412872314456
       theta2 = theta2 + 0.08202178955078127
       theta3 = theta3 + 0.70237060546875
       theta2 = theta2*(-1)
       print(theta1, theta2, theta3)
       # T_0_1 (base_link to leg_front_l_1)
       T_0_1 = self.translation(-0.045, 0.06, 0) @ self.rotation_y(theta1)
       ...
       # T_2_3 (leg_front_l_2 to leg_front_l_3)
       ## TODO: Implement the transformation matrix from leg_front_l_2 to leg_front_l_3
       T_2_3 = self.translation(-0.08, 0, -0.06) @ self.rotation_y(theta3)
   ...
   def timer_callback(self):
       ...
       if self.joint_positions is not None:
           # Joint angles
           theta1_f = self.joint_positions[0] - 0.034373970031738255
           theta2_f = self.joint_positions[1] - 0.019451065063476547
           theta3_f = self.joint_positions[2] + 0.6920709228515625
           theta1_b = self.joint_positions[3] + 0.08922412872314456
           theta2_b = self.joint_positions[4] + 0.08202178955078127
           theta3_b = self.joint_positions[5] + 0.70237060546875
           ...
           dist = np.linalg.norm(end_effector_position_f - end_effector_position_b)
           print(dist)
           ...
           if dist < 0.07:
               ...
               if not pygame.mixer.get_busy():
                   sound.play()
                   self.get_logger().warn(f"CRASH IMMINENT! Distance: {dist:.3f}")
           ...
           self.get_logger().info(
               ...
               f"BACK End-Effector Position: x={end_effector_position_b[0]:.2f}, y={end_effector_position_b[1]:.2f}, z={end_effector_position_b[2]:.2f}"
           )
